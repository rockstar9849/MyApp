...
public class ConfirmationActivity extends AppCompatActivity {
    ...
    private com.example.presentation.DatabaseHelper helper = null;
        ...
        fbt.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View view){
                        Intent i = new Intent(com.example.presentation.ConfirmationActivity.this, InputActivity.class);
    ...
    private ArrayList<ListItem> loadAlarms(){
        helper = com.example.presentation.DatabaseHelper.getInstance(this);
